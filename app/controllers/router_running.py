...
from app.services.asset_creation import asset_creation, send_email_with_image
...
async def asset_data(data: assetCreation, background_tasks: BackgroundTasks):
    try:
        ...
        extraction_id_brand_document = data.extraction_id_brand_document
        extraction_id_tone_of_voice = data.extraction_id_tone_of_voice



        background_tasks.add_task(asset_creation, table_name, user_id, project_id, extraction_id_brand_document, extraction_id_tone_of_voice, file_id_logo, file_id_picture_bank_image)
