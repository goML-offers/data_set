...
def generate_text(cluster_description, categorical_description, asset_to_individulize_file, tone_of_voice):
    ...
    Also give me a two to three words headline as well. It should be in a json format having two keys summary and  only having key and value enclosed in double quotes.
...
def asset_creation(table_name, user_id, project_id, extraction_id_brand, extraction_id_tone, file_id_log, file_id_background_image):
    ...
    try:
        ...
        #     print(categorical_description)
            ...
            data_description = f"numerical column cluster: {cluster_description} and categorical column cluster {categorical_description}"
